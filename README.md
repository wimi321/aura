...
> **APK size**: ~63 MB for the Android arm64 release — the model downloads separately on first launch, then you never need internet again.
...
<details>
<summary><strong>Why is the APK ~63 MB?</strong></summary>
